...
sb         -> List(N, N, SrcType.REG,  SrcType.IMM,  FuType.AGU, LSUOp.SB,        ImmType.S),
sh         -> List(N, N, SrcType.REG,  SrcType.IMM,  FuType.AGU, LSUOp.SH,        ImmType.S),
sw         -> List(N, N, SrcType.REG,  SrcType.IMM,  FuType.AGU, LSUOp.SW,        ImmType.S),
