#ifndef AT_SCANCODE_H__
#define AT_SCANCODE_H__
...
#define GET_SECOND_OR_DEFAULT(value, default) GET_SECOND_OR_DEFAULT_(value, default) 
#define GET_SECOND_OR_DEFAULT_(a, b, ...) b
